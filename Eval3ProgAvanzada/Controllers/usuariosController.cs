...
namespace Eval3ProgAvanzada.Controllers
{
    public class usuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Rol,Email,MaxHerramientasEnUso")] usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Rol,Email,MaxHerramientasEnUso")] usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
